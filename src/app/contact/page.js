...
{/* Contact Section */}
<section className="min-h-screen bg-gradient-to-r from-[#070F2B] to-[#1B1A55] text-white flex items-center justify-center p-8">
  <div className="max-w-2xl w-full bg-[#535C91] bg-opacity-80 rounded-lg shadow-lg p-8 space-y-6">
    {/* Section Title */}
    <h2 className="text-3xl font-bold text-center text-[#FFFFF]">
      Get in Touch
    </h2>
    <p className="text-center text-[#FFFFF]">
      Feel free to reach out for collaborations or just a friendly chat.
    </p>

    {/* Contact Form */}
    <form
      action="https://formsubmit.co/svartika841@gmail.com" 
      method="POST"
      className="space-y-4"
    >
      {/* Name Field */}
      <div>
        <label htmlFor="name" className="block text-sm font-medium text-[#FFFFF]">
          Name
        </label>
        <input
          type="text"
          ...
          name="name"
          required
          className="w-full mt-1 p-3 rounded-lg bg-[#1B1A55] text-white border border-[#535C91] focus:outline-none focus:ring-2 focus:ring-[#9290C3]"
      ...
      {/* Email Field */}
      <div>
        <label htmlFor="email" className="block text-sm font-medium text-[#FFFFF]">
          Email
        </label>
        <input
          type="email"
      ...
      {/* Message Field */}
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-[#FFFFF]">
          Message
        </label>
        <textarea
          id="message"
      ...
      <div className="text-center">
        <button
          type="submit"
          className="px-6 py-3 bg-[#1B1A55] text-white rounded-lg font-semibold hover:bg-[#535C91] transition"
        >
          Send Message
        </button>
      </div>
